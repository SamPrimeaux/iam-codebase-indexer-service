...
var Language = class _Language {
  ...
  */
   ...
   * The module can be provided as a compiled Module, a path to a file, or a buffer.
   */
...
async function Module2(moduleArg = {}) {
  ...
  // IAM: Cloudflare Workers + nodejs_compat set process.versions.node, but the
  // bundled import.meta.url is not a file: URL — createRequire(undefined) throws
  // "path must be a file URL… Received 'undefined'" and kills every parse.
  // Only take the Node fs path when we truly have a local file: module URL.
